...
`;
const buildGuestRuntimeSetupSource = (hostFunctionNamespaces, syncHostFunctionNamespaces = []) => {
...
const wrapUserCode = (js) => `
globalThis.__runResult = (async () => {
${js}
})();
`;
export {
  buildGuestRuntimeSetupSource,
  wrapUserCode
};
//# sourceMappingURL=guest-sources.js.map